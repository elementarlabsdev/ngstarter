...
@Component({
  selector: 'app-data-view-pinning-pagination-example',
  standalone: true,
  imports: [
    DataView
  ],
  templateUrl: './data-view-pinning-pagination-example.html',
})
export class DataViewPinningPaginationExample {
  columnDefs: DataViewColumnDef[] = [
    ...
    { name: 'Discovery Year', field: 'discoveryYear', visible: true, resizable: true, sortable: true, width: '150px' },
    ...
    { name: 'Electron Configuration', field: 'electronConfiguration', visible: true, resizable: true, sortable: true, width: '200px' },
